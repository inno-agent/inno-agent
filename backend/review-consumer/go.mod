module github.com/inno-agent/inno-agent/backend/review-consumer
...
require (
	...
	github.com/inno-agent/inno-agent/backend/pkg/tracing v0.0.0
...
replace github.com/inno-agent/inno-agent/backend/pkg/tracing => ../pkg/tracing
